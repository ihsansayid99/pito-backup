        ...
        <>
            <section className="flex flex-col md:flex-row">
                ...
                <div className="pt-20 flex w-full">
                    <div className="w-3/5 xxl:1/2 px-4">
                        <div className="flex items-center">
                            <img src={userAvatarDummy} draggable={false} className="rounded-full w-1/3 border-8 mr-4 border-red-600 mx-auto" alt="" />
                            {
                                tableBodyUser.filter(x => x.id === match.params.id).map(x => {
                                    return (
                                        <div key={x.id} className="px-8 w-auto">
                        ...
                        <div className="flex flex-wrap pt-8">
                            <button className="rounded-3xl font-medium mr-6 text-red-600 border border-red-600 px-12 py-2">Disable</button>
                            <button className="rounded-3xl font-medium mr-6 text-white bg-red-600 px-12 py-2">Edit Account</button>
                            <button className="rounded-3xl font-medium text-white bg-red-600 px-8 py-2">Create Livestreams</button>
                        </div>
                        <div className="pt-8">
                            <LineCustom />
                        </div>
