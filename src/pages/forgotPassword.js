...
const ForgotPassword = () => {
    return (
        <div className="bg-red-600 py-20  w-screen h-screen">
            <div className="fp-controller bg-white rounded-2xl w-2/5 mx-auto px-6 py-20 xxl:py-40">
                <Pito className="mx-auto" />
                <div className="mt-16 xxl:mt-32 flex flex-col px-10 ">
                    ...
                    <button className="w-1/2 bg-red-600 mt-6 mx-auto text-white font-medium text-lg py-2 rounded-3xl">Submit</button>
                </div>
            </div>
        </div >
    )
